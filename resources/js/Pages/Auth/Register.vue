                    ...
                    <div class="w-full py-10 px-10 md:px-10">
                        ...
                        <form @submit.prevent="submit">
                            <div>
                                ...
                                <jet-input id="name" type="text" class="text-black mt-1 block w-full" v-model="form.name" required autofocus autocomplete="name" />
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <jet-input id="password" type="password" class="text-black mt-1 block w-full" v-model="form.password" required autocomplete="new-password" />
                            </div>
    
                            <div class="mt-4">
                                <jet-label for="password_confirmation" value="Confirm Password" />
                                <jet-input id="password_confirmation" type="password" class="text-black mt-1 block w-full" v-model="form.password_confirmation" required autocomplete="new-password" />
                            </div>
